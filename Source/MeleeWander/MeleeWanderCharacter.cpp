...
AMeleeWanderCharacter::AMeleeWanderCharacter()
{
...
void AMeleeWanderCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMeleeWanderCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMeleeWanderCharacter::Look);

		// Dodging
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMeleeWanderCharacter::Dodge);
	}
	else
	{
...
void AMeleeWanderCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMeleeWanderCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
UMeleeAbilitySystemComponent* AMeleeWanderCharacter::GetMeleeAbilitySystemComponent() const
{
	return Cast<UMeleeAbilitySystemComponent>(GetAbilitySystemComponent());
}

UAbilitySystemComponent* AMeleeWanderCharacter::GetAbilitySystemComponent() const
{
